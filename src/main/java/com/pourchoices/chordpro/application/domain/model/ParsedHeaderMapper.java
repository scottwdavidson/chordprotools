...
// TODO Convert this to business logic so after a CatalogEntry model class is available
@Component
public class ParsedHeaderMapper {


    public ParsedHeader fromCatalogEntry(List<CatalogEntry> catalogEntries) {
